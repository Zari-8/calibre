...
import { KEY_STAT_FIELDS, per90Value, keyStatValue, percentileRank } from '../services/percentiles.js';
...
// Percentile-vs-pool engine (KEY_STAT_FIELDS, per90Value, keyStatValue,
// percentileRank) now lives in services/percentiles.js — shared with System
// Fit's report so both pages read the same numbers off the same formula
