    ...
    <div className="home-page">
      <section className="home-hero-v2">
        <img
          ...
          src="/assets/hero-backview-footballer.png"
          alt=""
          aria-hidden="true"
        />
        <div className="home-hero-v2__shade" aria-hidden="true" />

        <div className="home-hero-v2__inner">
          <div className="home-hero-v2__copy">
            <span className="home-hero-v2__eyebrow">
              <i /> Football intelligence for the arguments that matter
            </span>

            <h1>
              <span>Who is</span>
              <span><em>really</em> better?</span>
              <span>Calibre has</span>
              <span>the answer.</span>
            </h1>

            <p>
              Rate players. Join live debates. Get system-fit verdicts.
              Discover the next stars before the world does.
            </p>

            <div className="home-hero-v2__actions">
              <button className="button button--primary" type="button" onClick={() => navigateTo('/talents')}>
                Explore talents <ArrowRight size={16} />
              </button>
            ...
            <div className="home-hero-v2__metrics">
              <div><strong>196K+</strong><span>Players</span></div>
              <div><strong>63</strong><span>Leagues</span></div>
              <div><strong>Live</strong><span>Debates</span></div>
              <div><strong>12K+</strong><span>Votes today</span></div>
            </div>
          </div>

          <div className="home-hero-v2__battle">
            <BattleHero />
          </div>
        </div>

        <div className="home-hero-v2__dock">
          <button className="home-hero-v2__card" type="button" onClick={() => navigateTo('/debates')}>
            <span><Zap size={24} /></span>
            <strong>Live debates</strong>
            <small>Hot takes. Real fans. Real football.</small>
            <em>Join the debate <ArrowRight size={14} /></em>
          </button>

          <button className="home-hero-v2__card" type="button" onClick={() => navigateTo('/system-fit')}>
            <span><Target size={24} /></span>
            <strong>System fit</strong>
            <small>Does this player fit your system?</small>
            <em>Check fit <ArrowRight size={14} /></em>
          </button>

          <button className="home-hero-v2__card" type="button" onClick={() => navigateTo('/talents')}>
            <span><Sparkles size={24} /></span>
            <strong>Talent discovery</strong>
            <small>Find tomorrow's stars today.</small>
            <em>Explore talents <ArrowRight size={14} /></em>
          </button>

          <button className="home-hero-v2__card" type="button" onClick={() => navigateTo('/transfers')}>
            <span><TrendingUp size={24} /></span>
            <strong>Transfer Intelligence</strong>
            <small>Track the moves before they happen.</small>
            <em>See transfers <ArrowRight size={14} /></em>
          </button>
        </div>
      </section>
