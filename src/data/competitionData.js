...
export const COMPETITION_GROUPS = {
  'Top Leagues': [
    { name: 'Premier League', country: 'England', logo: 'ENG', id: 39, table: true, stage: 'Matchday 38', hero: 'The pressure cooker', teams: ['Liverpool', 'Arsenal', 'Manchester City', 'Chelsea', 'Newcastle'], scorerRows: [['E. Haaland', 'Manchester City', 27], ['M. Salah', 'Liverpool', 24], ['A. Isak', 'Newcastle', 21], ['C. Palmer', 'Chelsea', 18], ['B. Saka', 'Arsenal', 16]], creatorRows: [['B. Saka', 'Arsenal', 13], ['P. Foden', 'Manchester City', 12], ['M. Ødegaard', 'Arsenal', 11], ['C. Palmer', 'Chelsea', 10], ['D. Szoboszlai', 'Liverpool', 9]] },
