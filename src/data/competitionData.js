...
export const COMPETITION_GROUPS = {
  'Top Leagues': [
    { name: 'Premier League', country: 'England', logo: 'ENG', id: 39, table: true, stage: 'Matchday 38', hero: 'The pressure cooker', teams: ['Liverpool', 'Arsenal', 'Manchester City', 'Chelsea', 'Newcastle', 'Aston Villa', 'Tottenham', 'Manchester United', 'West Ham', 'Brighton', 'Crystal Palace', 'Bournemouth', 'Fulham', 'Wolves', 'Everton', 'Brentford', 'Nottingham Forest', 'Leicester City', 'Ipswich Town', 'Southampton'], scorerRows: [['E. Haaland', 'Manchester City', 27], ['M. Salah', 'Liverpool', 24], ['A. Isak', 'Newcastle', 21], ['C. Palmer', 'Chelsea', 18], ['B. Saka', 'Arsenal', 16]], creatorRows: [['B. Saka', 'Arsenal', 13], ['P. Foden', 'Manchester City', 12], ['M. Ødegaard', 'Arsenal', 11], ['C. Palmer', 'Chelsea', 10], ['D. Szoboszlai', 'Liverpool', 9]] },
    { name: 'La Liga', country: 'Spain', logo: 'ESP', id: 140, table: true, stage: 'Matchday 38', hero: 'Control, chaos and technical power', teams: ['FC Barcelona', 'Real Madrid', 'Atlético Madrid', 'Athletic Club', 'Real Sociedad', 'Villarreal', 'Real Betis', 'Girona', 'Valencia', 'Sevilla', 'Osasuna', 'Celta Vigo', 'Rayo Vallecano', 'Getafe', 'Mallorca', 'Alavés', 'Las Palmas', 'Espanyol', 'Leganés', 'Valladolid'], scorerRows: [['K. Mbappé', 'Real Madrid', 29], ['R. Lewandowski', 'FC Barcelona', 24], ['V. Júnior', 'Real Madrid', 19], ['L. Yamal', 'FC Barcelona', 16], ['J. Álvarez', 'Atlético Madrid', 15]], creatorRows: [['L. Yamal', 'FC Barcelona', 15], ['Pedri', 'FC Barcelona', 11], ['J. Bellingham', 'Real Madrid', 10], ['Raphinha', 'FC Barcelona', 10], ['N. Williams', 'Athletic Club', 9]] },
    { name: 'Bundesliga', country: 'Germany', logo: 'GER', id: 78, table: true, stage: 'Matchday 34', hero: 'Tempo, pressure and transition volume', teams: ['Bayern München', 'Bayer Leverkusen', 'Borussia Dortmund', 'RB Leipzig', 'Eintracht Frankfurt', 'VfB Stuttgart', 'SC Freiburg', 'VfL Wolfsburg', 'Mainz 05', 'Werder Bremen', 'Borussia Mönchengladbach', 'FC Augsburg', 'Hoffenheim', 'Union Berlin', 'VfL Bochum', 'FC Heidenheim', 'Holstein Kiel', 'FC St. Pauli'], scorerRows: [['H. Kane', 'Bayern München', 28], ['S. Guirassy', 'Dortmund', 22], ['V. Boniface', 'Leverkusen', 18], ['L. Openda', 'RB Leipzig', 17], ['J. Musiala', 'Bayern München', 14]], creatorRows: [['F. Wirtz', 'Leverkusen', 14], ['J. Musiala', 'Bayern München', 12], ['X. Simons', 'RB Leipzig', 10], ['J. Brandt', 'Dortmund', 9], ['A. Grimaldo', 'Leverkusen', 9]] },
    { name: 'Serie A', country: 'Italy', logo: 'ITA', id: 135, table: true, stage: 'Matchday 38', hero: 'Structure and tactical leverage', teams: ['Inter', 'Napoli', 'Atalanta', 'Juventus', 'AC Milan', 'Bologna', 'Roma', 'Lazio', 'Fiorentina', 'Torino', 'Udinese', 'Genoa', 'Monza', 'Verona', 'Cagliari', 'Lecce', 'Empoli', 'Parma', 'Como', 'Venezia'], scorerRows: [['L. Martínez', 'Inter', 22], ['M. Retegui', 'Atalanta', 20], ['D. Vlahović', 'Juventus', 18], ['R. Lukaku', 'Napoli', 16], ['M. Thuram', 'Inter', 15]], creatorRows: [['N. Barella', 'Inter', 11], ['C. Pulisic', 'AC Milan', 10], ['A. Lookman', 'Atalanta', 9], ['K. Kvaratskhelia', 'Napoli', 9], ['T. Koopmeiners', 'Juventus', 8]] },
    { name: 'Ligue 1', country: 'France', logo: 'FRA', id: 61, table: true, stage: 'Matchday 34', hero: 'Youth pipeline and elite upside', teams: ['Paris Saint-Germain', 'Monaco', 'Marseille', 'Lille', 'Lyon', 'Nice', 'Lens', 'Rennes', 'Strasbourg', 'Brest', 'Toulouse', 'Reims', 'Nantes', 'Montpellier', 'Auxerre', 'Le Havre', 'Angers', 'Saint-Étienne'], scorerRows: [['O. Dembélé', 'PSG', 22], ['J. David', 'Lille', 19], ['M. Greenwood', 'Marseille', 18], ['B. Barcola', 'PSG', 15], ['A. Lacazette', 'Lyon', 14]], creatorRows: [['Vitinha', 'PSG', 12], ['O. Dembélé', 'PSG', 11], ['A. Golovin', 'Monaco', 10], ['R. Cherki', 'Lyon', 10], ['E. Zhegrova', 'Lille', 9]] },
    { name: 'Eredivisie', country: 'Netherlands', logo: 'NED', id: 88, table: true, stage: 'Matchday 34', hero: 'Development football with real export value', teams: ['PSV Eindhoven', 'Ajax', 'Feyenoord', 'AZ Alkmaar', 'FC Twente', 'FC Utrecht', 'Go Ahead Eagles', 'Sparta Rotterdam', 'NEC Nijmegen', 'Heerenveen', 'Groningen', 'Fortuna Sittard', 'PEC Zwolle', 'Heracles', 'Willem II', 'Almere City', 'RKC Waalwijk', 'NAC Breda'], scorerRows: [['L. de Jong', 'PSV', 23], ['S. Giménez', 'Feyenoord', 21], ['B. Brobbey', 'Ajax', 18], ['V. Pavlidis', 'AZ', 17], ['R. Pepi', 'PSV', 15]], creatorRows: [['J. Veerman', 'PSV', 13], ['S. Berghuis', 'Ajax', 11], ['C. Stengs', 'Feyenoord', 10], ['Y. Sugawara', 'AZ', 9], ['N. Lang', 'PSV', 8]] },
    { name: 'Belgian Pro League', country: 'Belgium', logo: 'BEL', id: 144, table: true, stage: 'Championship Round', hero: 'A launchpad league for the next move', teams: ['Club Brugge', 'Union SG', 'Genk', 'Anderlecht', 'Gent', 'Antwerp', 'Cercle Brugge', 'Standard Liège', 'KV Mechelen', 'Charleroi', 'Westerlo', 'OH Leuven', 'Sint-Truiden', 'Kortrijk', 'Dender', 'Beerschot'], scorerRows: [['T. Arokodare', 'Genk', 20], ['G. Nilsson', 'Club Brugge', 16], ['K. Dolberg', 'Anderlecht', 15], ['M. Amoura', 'Union SG', 14], ['H. Cuypers', 'Gent', 13]], creatorRows: [['H. Vanaken', 'Club Brugge', 12], ['B. El Khannouss', 'Genk', 10], ['C. Puertas', 'Union SG', 9], ['Y. Verschaeren', 'Anderlecht', 8], ['A. Hjulsager', 'Gent', 8]] },

    { name: 'Primeira Liga', country: 'Portugal', logo: 'POR', id: 94, table: true, stage: 'Matchday 34', hero: 'Technical development with a direct route to Europe', teams: ['Sporting CP', 'Benfica', 'Porto', 'Braga', 'Vitória SC', 'Famalicão', 'Moreirense', 'Santa Clara', 'Estoril', 'Gil Vicente', 'Casa Pia', 'Rio Ave', 'Arouca', 'Nacional', 'Boavista', 'Estrela Amadora', 'Farense', 'AVS'], scorerRows: [['V. Gyökeres', 'Sporting CP', 28], ['S. Pavlidis', 'Benfica', 19], ['Samu Aghehowa', 'Porto', 17], ['Bruma', 'Braga', 14], ['F. Trincão', 'Sporting CP', 12]], creatorRows: [['P. Gonçalves', 'Sporting CP', 12], ['Á. Di María', 'Benfica', 10], ['F. Trincão', 'Sporting CP', 9], ['R. Horta', 'Braga', 8], ['Pepê', 'Porto', 8]] },
    { name: 'Brasileirão Série A', country: 'Brazil', logo: 'BRA', id: 71, table: true, stage: 'League Season', hero: 'South American pressure, talent and tactical invention', teams: ['Flamengo', 'Palmeiras', 'Botafogo', 'Atlético Mineiro', 'Fluminense', 'São Paulo', 'Internacional', 'Cruzeiro', 'Grêmio', 'Corinthians', 'Bahia', 'Vasco da Gama', 'Fortaleza', 'Vitória', 'Juventude', 'Bragantino', 'Criciúma', 'Athletico Paranaense', 'Cuiabá', 'Atlético Goianiense'], scorerRows: [['Pedro', 'Flamengo', 18], ['Estêvão', 'Palmeiras', 15], ['Tiquinho', 'Botafogo', 14], ['Hulk', 'Atlético Mineiro', 13], ['J. Arias', 'Fluminense', 11]], creatorRows: [['G. Arrascaeta', 'Flamengo', 12], ['Raphael Veiga', 'Palmeiras', 10], ['J. Arias', 'Fluminense', 10], ['Luiz Henrique', 'Botafogo', 8], ['Paulinho', 'Atlético Mineiro', 8]] },
  ],
  'Top Tournaments': [
  ...
  'Domestic Cups': [
    { name: 'FA Cup', country: 'England', logo: 'FAC', id: 45, table: false, stage: 'Cup Rounds', hero: 'One bad night and the season changes', teams: ['Manchester City', 'Arsenal', 'Liverpool', 'Chelsea', 'Manchester United'], scorerRows: [['E. Haaland', 'Manchester City', 5], ['B. Saka', 'Arsenal', 4], ['M. Salah', 'Liverpool', 4], ['C. Palmer', 'Chelsea', 3], ['B. Fernandes', 'Manchester United', 3]], creatorRows: [['P. Foden', 'Manchester City', 4], ['M. Ødegaard', 'Arsenal', 3], ['T. Alexander-Arnold', 'Liverpool', 3], ['C. Palmer', 'Chelsea', 3], ['B. Fernandes', 'Manchester United', 2]] },
    ...
    { name: 'KNVB Cup', country: 'Netherlands', logo: 'KNVB', id: 90, table: false, stage: 'Cup Rounds', hero: 'Dutch knockout football, development pressure included', teams: ['PSV Eindhoven', 'Ajax', 'Feyenoord', 'AZ Alkmaar', 'FC Twente', 'FC Utrecht', 'Go Ahead Eagles', 'Sparta Rotterdam', 'NEC Nijmegen', 'Heerenveen', 'Groningen', 'Fortuna Sittard', 'PEC Zwolle', 'Heracles', 'Willem II', 'Almere City', 'RKC Waalwijk', 'NAC Breda'], scorerRows: [['R. Pepi', 'PSV', 5], ['B. Brobbey', 'Ajax', 4], ['S. Giménez', 'Feyenoord', 4], ['V. Pavlidis', 'AZ', 3], ['S. Steijn', 'FC Twente', 3]], creatorRows: [['J. Veerman', 'PSV', 4], ['S. Berghuis', 'Ajax', 3], ['C. Stengs', 'Feyenoord', 3], ['Y. Sugawara', 'AZ', 2], ['M. Vlap', 'FC Twente', 2]] },
    { name: 'Belgian Cup', country: 'Belgium', logo: 'BEC', id: 147, table: false, stage: 'Cup Rounds', hero: 'Belgian knockout football and pathway pressure', teams: ['Club Brugge', 'Union SG', 'Genk', 'Anderlecht', 'Gent', 'Antwerp', 'Cercle Brugge', 'Standard Liège', 'KV Mechelen', 'Charleroi', 'Westerlo', 'OH Leuven', 'Sint-Truiden', 'Kortrijk', 'Dender', 'Beerschot'], scorerRows: [['T. Arokodare', 'Genk', 5], ['G. Nilsson', 'Club Brugge', 4], ['K. Dolberg', 'Anderlecht', 4], ['M. Amoura', 'Union SG', 3], ['H. Cuypers', 'Gent', 3]], creatorRows: [['H. Vanaken', 'Club Brugge', 4], ['B. El Khannouss', 'Genk', 3], ['C. Puertas', 'Union SG', 3], ['Y. Verschaeren', 'Anderlecht', 2], ['A. Hjulsager', 'Gent', 2]] },
    ...
    { name: 'Copa do Brasil', country: 'Brazil', logo: 'CDB', id: 73, table: false, stage: 'Cup Rounds', hero: 'Brazilian knockout football with continental-level pressure', teams: ['Flamengo', 'Palmeiras', 'Botafogo', 'Atlético Mineiro', 'Fluminense', 'São Paulo', 'Internacional', 'Cruzeiro', 'Grêmio', 'Corinthians', 'Bahia', 'Vasco da Gama', 'Fortaleza', 'Vitória', 'Juventude', 'Bragantino', 'Criciúma', 'Athletico Paranaense', 'Cuiabá', 'Atlético Goianiense'], scorerRows: [['Pedro', 'Flamengo', 6], ['Estêvão', 'Palmeiras', 5], ['Tiquinho', 'Botafogo', 4], ['Hulk', 'Atlético Mineiro', 4], ['J. Arias', 'Fluminense', 3]], creatorRows: [['G. Arrascaeta', 'Flamengo', 5], ['Raphael Veiga', 'Palmeiras', 4], ['J. Arias', 'Fluminense', 4], ['Luiz Henrique', 'Botafogo', 3], ['Paulinho', 'Atlético Mineiro', 3]] },
  ],
  "Women's Football": [
    { name: "Women's Super League", country: 'England', logo: 'WSL', id: 44, table: false, stage: 'League Hub', hero: 'The English women’s game under a bigger spotlight', teams: ['Chelsea Women', 'Arsenal Women', 'Manchester City Women', 'Manchester United Women', 'Brighton Women', 'Liverpool Women', 'Aston Villa Women', 'Tottenham Women', 'Everton Women', 'West Ham Women'], scorerRows: [['K. Shaw', 'Manchester City Women', 19], ['A. Russo', 'Arsenal Women', 16], ['L. James', 'Chelsea Women', 14], ['E. Toone', 'Manchester United Women', 11], ['N. Parris', 'Brighton Women', 10]], creatorRows: [['L. Hemp', 'Manchester City Women', 12], ['C. Reiten', 'Chelsea Women', 11], ['B. Mead', 'Arsenal Women', 10], ['E. Toone', 'Manchester United Women', 9], ['F. Kirby', 'Brighton Women', 8]] },
    { name: "Women's Champions League", country: 'Europe', logo: 'UWCL', id: 525, table: true, standingsMode:'tournament-only', stage: 'Knockout Stage', hero: 'Europe’s elite women’s clubs, same pressure', teams: ['FC Barcelona Femení', 'Chelsea Women', 'Lyon Féminin', 'Arsenal Women', 'Bayern Women'], scorerRows: [['A. Putellas', 'Barcelona Femení', 8], ['C. Graham Hansen', 'Barcelona Femení', 7], ['L. James', 'Chelsea Women', 6], ['K. Diani', 'Lyon Féminin', 6], ['A. Russo', 'Arsenal Women', 5]], creatorRows: [['A. Bonmatí', 'Barcelona Femení', 7], ['C. Graham Hansen', 'Barcelona Femení', 6], ['C. Reiten', 'Chelsea Women', 5], ['D. Marozsán', 'Lyon Féminin', 5], ['B. Mead', 'Arsenal Women', 4]] },
    { name: 'Liga F', country: 'Spain', logo: 'LIGAF', id: 142, table: false, stage: 'League Hub', hero: 'Technical dominance and the Barcelona benchmark', teams: ['FC Barcelona Femení', 'Real Madrid Femenino', 'Atlético Femenino', 'Levante Women', 'Real Sociedad Women', 'Athletic Club Women', 'Sevilla Women', 'Valencia Women', 'Granada Women', 'Real Betis Women'], scorerRows: [['E. Pajor', 'Barcelona Femení', 22], ['A. Putellas', 'Barcelona Femení', 17], ['L. Caicedo', 'Real Madrid Femenino', 14], ['S. Ajibade', 'Atlético Femenino', 12], ['N. Eizagirre', 'Real Sociedad Women', 10]], creatorRows: [['A. Bonmatí', 'Barcelona Femení', 15], ['C. Graham Hansen', 'Barcelona Femení', 13], ['L. Caicedo', 'Real Madrid Femenino', 10], ['S. Ajibade', 'Atlético Femenino', 8], ['N. Eizagirre', 'Real Sociedad Women', 7]] },
    { name: 'NWSL', country: 'United States', logo: 'NWSL', id: 254, table: false, stage: 'League Hub', hero: 'Athletic depth, parity and major-market energy', teams: ['Orlando Pride', 'Washington Spirit', 'Portland Thorns', 'Gotham FC', 'Kansas City Current', 'San Diego Wave', 'NC Courage', 'Racing Louisville', 'Chicago Red Stars', 'Angel City'], scorerRows: [['B. Banda', 'Orlando Pride', 18], ['T. Rodman', 'Washington Spirit', 14], ['S. Smith', 'Portland Thorns', 13], ['E. González', 'Gotham FC', 12], ['T. Chawinga', 'Kansas City Current', 11]], creatorRows: [['M. Marta', 'Orlando Pride', 10], ['T. Rodman', 'Washington Spirit', 9], ['S. Smith', 'Portland Thorns', 8], ['R. Lavelle', 'Gotham FC', 8], ['D. DiBernardo', 'Kansas City Current', 7]] },
  ],
};

// A cup / knockout / continental tournament has no league table. Detected by
// stage, NOT by `table` — women's leagues carry table:false but are still
// leagues (stage 'League Hub') and must keep their ladder.
export function isKnockoutCompetition(competition) {
  return /cup rounds|knockout|continental tournament|tournament hub/i.test(competition?.stage || '');
}

export function snapshotFor(competition) {
  return {
    standings: isKnockoutCompetition(competition) ? [] : standings(competition.teams),
...
export function featuredMatchFor(competition) {
  const fallback = MATCH_OVERRIDES[competition.name] || {
    ...
    headline: `${competition.teams[0]} vs ${competition.teams[1]}: who imposes their game?`,
    pregame: `${competition.teams[0]} and ${competition.teams[1]} arrive with different plans. ${competition.teams[0]} will want to set the tempo and pin the game high; ${competition.teams[1]} will stay compact and look to hurt them in transition. Whoever imposes their rhythm first usually decides which way this one breaks.`,
