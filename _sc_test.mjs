        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between" }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 10 }, children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { width: 14, height: 14, borderRadius: 4, background: "#c8ff00" } }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 22, fontWeight: 800, letterSpacing: "0.08em", textTransform: "uppercase", display: "flex" }, children: "Calibre" })
            ] }),
            showCrestRow && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 14 }, children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Crest, { label: fromCrest || "?", color: null }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 26, color: "#555", display: "flex" }, children: "\u2192" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Crest, { label: toCrest || "?", color: toColor })
            ] })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", flex: 1, gap: 48, marginTop: 16 }, children: [
            img ? (
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", flex: 1 }, children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 54, fontWeight: 800, lineHeight: 1.05, display: "flex" }, children: name }),
              meta && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 22, color: "#999", marginTop: 10, display: "flex" }, children: meta }),
              showPremiumHero ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", marginTop: 24 }, children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                  "div",
                  {
                    style: {
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { fontSize: 20, color: "#999", marginTop: 10, display: "flex" }, children: [
                  "Asking \u20AC",
                  asking,
                  "M \xB7 Calibre fair value \u20AC",
                  value,
                  "M"
                ] })
              ] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { display: "flex", alignItems: "flex-end", gap: 28, marginTop: 34 }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column" }, children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 15, color: "#666", letterSpacing: "0.1em", textTransform: "uppercase", display: "flex" }, children: "Calibre Estimated Value" }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 76, fontWeight: 800, color: "#c8ff00", lineHeight: 1.05, display: "flex" }, children: value ? `\u20AC${value}M` : "\u2014" }),
                fair && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { fontSize: 18, color: "#777", marginTop: 4, display: "flex" }, children: [
                  "Fair range \u20AC",
                  fair,
                  "M"
                ] })
              ] }) }),
              stats.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { display: "flex", gap: 40, marginTop: 26, paddingTop: 20, borderTop: "1px solid #1c1c1c" }, children: stats.map((s) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column" }, children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 14, color: "#666", letterSpacing: "0.08em", display: "flex" }, children: s.label }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 30, fontWeight: 800, color: accent, display: "flex" }, children: s.v })
              ] }, s.label)) })
            ] })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { display: "flex" }, children: "calibrefootball.com/transfers" }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { display: "flex" }, children: "Ability-based \xB7 position, league & age adjusted" })
              ]
            }
          ),
          verdict && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "div",
            {
              style: {
                position: "absolute",
